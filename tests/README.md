...
theory block (`IA_code: 1`). Test 16 evaluates both at the same 30
...
difference reached $\Delta\chi^2 = 2248$ across the prior. The point values, the design, and the
...
**Step :two:**: run the baryonic feedback checks of this project
    ...
    python -m pytest ./projects/roman_real/tests/test_accuracy_baryons.py
...
**Step :two:**: run the drift tests of this project
    ...
    python -m pytest ./projects/roman_real/tests/test_baryons.py
