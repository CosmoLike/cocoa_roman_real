...
method's own training box (on this project's fiducial, BACCOemu's
omega_baryon boundary sits exactly at omegab = 0.04); the check then
reports the rejection as documented behavior instead of a number.
