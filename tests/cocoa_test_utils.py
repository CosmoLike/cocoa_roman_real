"""Shared harness for the roman_real unit tests: the project's data
...
# The 10 Halofit-vs-EE2 comparison cosmologies (omegam/ns/As draws,
# no project prefix); the values are identical in every project.
