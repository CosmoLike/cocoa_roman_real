"""Shared harness for the roman_real unit tests.

The tests answer two questions about the roman_real likelihoods:
...
examples use different data-set dimensions (roman_real), the cosmolike
...
# =============================================================================
# SECTION: THE CFASTPT VS FASTPT COMPARISON (test 16)
# =============================================================================
...
# Test 16 evaluates the SAME intrinsic-alignment points with
