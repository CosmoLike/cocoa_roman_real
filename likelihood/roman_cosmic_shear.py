from cobaya.likelihoods.roman._cosmolike_prototype_base import _cosmolike_prototype_base
import cosmolike_roman_interface as ci
import numpy as np

class roman_cosmic_shear(_cosmolike_prototype_base):
  def initialize(self):
    super(roman_cosmic_shear,self).initialize(probe="xi")
