from cobaya.likelihoods.ROMAN_real_emu_emu._cosmolike_prototype_base import _cosmolike_prototype_base, survey
import cosmolike_ROMAN_real_emu_emu_interface as ci
import numpy as np

class ROMAN_real_emu_emu_cosmic_shear(_cosmolike_prototype_base):
  def initialize(self):
    super(ROMAN_real_emu_emu_cosmic_shear,self).initialize(probe="xi")
